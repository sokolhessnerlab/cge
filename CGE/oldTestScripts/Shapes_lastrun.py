...
expName = 'Shapes'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/shlab/Documents/GitHub/cge/CGE/Shapes_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Testing out shapes to be manipulated',
    font='Open Sans',
...
# --- Initialize components for Routine "SEMI" ---
polygon = visual.ShapeStim(
    win=win, name='polygon',units='cm', 
    size=(12, 12), vertices='circle',
...
_key_resp_2_allKeys = []
# keep track of which components have finished
SEMIComponents = [polygon, polygon_2, key_resp_2]
for thisComponent in SEMIComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
thisExp.nextEntry()
# the Routine "SEMI" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
