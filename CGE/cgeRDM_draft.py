...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\jvonm\\Documents\\GitHub\\cge\\CGE\\cgeRDM_draft.py',
...
for thisPracTrial in pracTrials:
    ...
    pracCircleRight.setFillColor([1,1,1])
    pracCircleRight.setLineColor([1,1,1])
    ...
    pracOCtext.setColor('black', colorSpace='rgb')
...
for thisStaticTrial in staticTrials:
    ...
    realCircleRight.setFillColor([1,1,1])
    realCircleRight.setLineColor([1,1,1])
    ...
    staticOCtext.setColor('black', colorSpace='rgb')
...
dynamicTrials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(fname[0]),
...
for thisDynamicTrial in dynamicTrials:
    ...
    dynamicOCtext.setColor('black', colorSpace='rgb')
